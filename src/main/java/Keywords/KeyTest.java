...
public class KeyTest {
    ...
    public void screenShot(String caso)
    {
        String NameCarpeta = "C:\\Users\\andy.alayo\\Desktop\\Automatizacion\\RetoAutomatizacionBPI\\Imagenes\\";
        String fileWithPath = NameCarpeta+"imagen_"+caso+".jpg";
